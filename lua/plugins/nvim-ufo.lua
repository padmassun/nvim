-- Source: https://github.com/rohit-kumar-j/dotfiles/blob/main/.config/nvim/lua/core/plugin_config/nvim-ufo.lua
-- https://www.reddit.com/r/neovim/comments/1emhivb/how_to_fold_only_2nd_or_nth_level_folds_in_a/
